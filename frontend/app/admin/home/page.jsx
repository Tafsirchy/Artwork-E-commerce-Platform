            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
              <div>
                ...
                <h1 className="text-4xl font-light text-gallery-text tracking-tight uppercase">
                  Curatorial <span className="font-serif text-gallery-gold">Dashboard</span>
                </h1>
              </div>
              ...
              <div className="space-y-8">
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    {/* Reviews Pagination */}
                    {totalReviewsPages > 1 && (
                      <div className="flex items-center justify-between pt-8 border-t border-gallery-border">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="px-6 py-2 border border-gallery-border text-[9px] tracking-widest uppercase font-bold hover:bg-white transition-all disabled:opacity-30"
                          >
                            Previous
                          </button>
                          <button
              ...
              <div className="space-y-8">
                <div className="bg-white p-8 border border-gallery-border space-y-6">
                  ...
                  {totalProductsPages > 1 && (
                    <div className="flex items-center justify-between pt-6 border-t border-gallery-border">
                      <p className="text-[10px] tracking-widest uppercase text-gallery-muted font-bold">
