        ...
        <div className="flex-1 w-full">
          ...
          >
            ...
            <p className="text-gallery-muted text-[10px] sm:text-sm tracking-[0.2em] sm:tracking-widest uppercase font-black mt-2">
              System Administration • Global Overview
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-10 sm:mb-12">
            {[
              ...
              { label: "Inventory", value: stats.products, icon: <Package size={20} />, title: `Inventory: ${stats.products} items` },
              { label: "Collectors", value: stats.users, icon: <Users size={20} />, title: `Active Collectors: ${stats.users}` }
            ].map((stat, i) => (
              <motion.div 
                key={i}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-10 sm:mb-12">
            {[
              { title: "Order Archives", desc: "View and update order statuses, generate invoices.", href: "/admin/orders" },
              { title: "Gallery Collection", desc: "Add new artwork, edit details, and track inventory.", href: "/admin/products" },
              { title: "Chronicle Records", desc: "Manage journal entries and artistic perspectives.", href: "/admin/blogs" },
              { title: "Message Center", desc: "Respond to art consultations and collector inquiries.", href: "/admin/messages" }
            ].map((card, i) => (
              <motion.div
                key={i}
          ...
          >
            ...
            <h2 className="text-xs tracking-[0.4em] uppercase text-gallery-gold font-black mb-8 border-b border-gallery-border pb-6">Promotional Management</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 relative z-10">
              <div className="flex items-center justify-between p-6 sm:p-8 border border-gallery-border bg-gallery-soft/20 group hover:border-gallery-gold transition-colors">
                <div className="pr-4">
                  <p className="text-sm font-black text-gallery-text uppercase tracking-widest mb-1">Entrance Slider</p>
                  <p className="text-[10px] text-gallery-muted uppercase tracking-widest font-bold">Visibility on landing</p>
                </div>
                <button 
              ...
              <div className="p-6 sm:p-8 border border-gallery-border bg-gallery-soft/20 group hover:border-gallery-gold transition-colors">
                <p className="text-sm font-black text-gallery-text uppercase tracking-widest mb-6">Global Curator Discount</p>
                ...
                <p className="text-[9px] text-gallery-muted uppercase tracking-[0.2em] mt-4 font-black italic">Applies to all non-discounted items in the collection.</p>
              </div>
            </div>
          </motion.div>
        </div>
