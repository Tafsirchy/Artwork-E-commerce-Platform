      ...
      <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row items-start gap-8 sm:gap-12">
        ...
        <div className="flex-1 w-full">
          <div className="mb-6 sm:mb-8 border-b border-gallery-border pb-6 sm:pb-8">
            ...
            <h1 className="text-2xl sm:text-3xl font-extralight text-gallery-text tracking-tighter uppercase">Messages</h1>
            <p className="text-gallery-muted text-[10px] sm:text-xs mt-2 uppercase tracking-[0.2em] font-bold">Manage customer messages.</p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6">
              {messages.length === 0 ? (
                <div className="bg-white border border-gallery-border p-20 text-center shadow-sm">
                  <p className="text-gallery-muted tracking-widest text-sm uppercase font-light">No messages found.</p>
                </div>
              ) : (
                    ...
                    <div className="p-6 sm:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                      <div className="flex-1 space-y-4 w-full">
                        <div className="flex items-center justify-between sm:justify-start gap-4">
                          ...
                          <span className={`text-[9px] px-3 py-1 border uppercase tracking-widest font-black shrink-0 ${message.status === 'new' ? 'bg-gallery-gold text-white border-gallery-gold' :
                        ...
                        <p className="text-gallery-muted text-sm font-light line-clamp-1 max-w-2xl ">
                          "{message.message}"
                        </p>
                      </div>
