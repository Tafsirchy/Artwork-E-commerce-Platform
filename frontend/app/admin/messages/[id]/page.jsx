...
export default function MessageDetailsPage() {
  ...
  const deleteMessage = async () => {
    if (!window.confirm("Archive this transmission permanently?")) return;
    try {
        ...
        <main className="flex-1 w-full">
          ...
          <div className="mb-8 sm:mb-12 border-b border-gallery-border pb-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-8">
              <div>
                <h1 className="text-3xl sm:text-5xl font-extralight text-gallery-text tracking-tighter uppercase leading-tight">Inquiry Record</h1>
                ...
                <div className="mb-12 sm:mb-20">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-[10px] tracking-[0.3em] uppercase font-black text-gallery-text">Identity Registry</span>
                    </div>
                  ...
                  <div className={`grid-cols-1 md:grid-cols-4 gap-10 sm:gap-16 pb-10 sm:pb-16 border-b border-gallery-border/50 transition-all duration-700 ${isInfoExpanded ? 'grid opacity-100' : 'hidden sm:grid opacity-0 sm:opacity-100'}`}>
                    <div className="space-y-2">
                      <span className="text-[10px] tracking-[0.4em] uppercase text-gallery-muted font-black block">Collector</span>
                      <p className="text-lg sm:text-xl font-black text-gallery-text uppercase tracking-tight leading-none">{message.name}</p>
                    </div>
                    <div className="space-y-2">
                      <span className="text-[10px] tracking-[0.4em] uppercase text-gallery-muted font-black block">Access Portal</span>
                    ...
                    <div className="space-y-2">
                      <span className="text-[10px] tracking-[0.4em] uppercase text-gallery-muted font-black block">Manifest</span>
                      <p className="text-lg sm:text-xl font-black text-gallery-gold uppercase tracking-tight">{message.subject}</p>
                    </div>
                    <div className="space-y-2">
                      <span className="text-[10px] tracking-[0.4em] uppercase text-gallery-muted font-black block">Transmission</span>
                      <p className="text-sm sm:text-lg font-light text-gallery-text tracking-tight italic">
                ...
                <article className="max-w-4xl mx-auto sm:mx-0">
                  <div className="flex items-center gap-6 mb-12">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[10px] tracking-[0.5em] uppercase text-gallery-gold font-black whitespace-nowrap">The Message</span>
                    </div>
                    <div className="h-px bg-gallery-gold/30 flex-1" />
                  </div>
      ...
      <AnimatePresence>
        {!loading && message && (
          ...
          >
            ...
            >
              <Mail size={18} strokeWidth={2.5} /> Respond Now
            </a>
          </motion.div>
        )}
      </AnimatePresence>
